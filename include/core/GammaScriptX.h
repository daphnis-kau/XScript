...
#define REGIST_CLASSFUNCTION_IMPLEMENT( _function_type, _function, _function_name ) \
	...
	{ \
		...
		{ \
			...
			Gamma::CScriptBase::RegistClassFunction( Gamma::CreateFunWrap( (_fun_type)(&org_class::_function) ), \
			GetFunction( (_fun_type)(&org_class::_function) ), Gamma::MakeClassFunArg( (_fun_type)(&org_class::_function) ), \
...
#define REGIST_STATICFUNCTION_IMPLEMENT( _function_type, _function, _function_name ) \
	...
	{ \
		...
		{ \
			typedef decltype ( (_function_type)nullptr ) _fun_type;\
			Gamma::CScriptBase::RegistClassStaticFunction( Gamma::CreateFunWrap( (_fun_type)(&org_class::_function) ), \
			GetFunction( (_fun_type)&org_class::_function ), Gamma::MakeFunArg( (_fun_type)(&org_class::_function) ), \
			typeid( org_class ).name(), #_function_name );\
		} \
	};  \
	static Gamma::CScriptRegisterNode _function_name##RegisterNode( listRegister, &_function_name##_Impl_Class::Register ); \
...
#define REGIST_CALLBACKFUNCTION_IMPLEMENT( _function_type, _function, _function_name ) \
	...
	struct _function_name##_Impl_ClassTemplate : public _BaseClass \
	{	\
		_RetType _function( Param ... p ) { throw; }\
		_RetType _function( Param ... p ) const { throw; }\
		typedef _function_name##_Impl_ClassTemplate<_BaseClass, _RetType, Param...> MyType; \
		struct __class : public org_class, public TCallBackBinder<MyType> {}; \
		static void Register(){ __class::Bind( #_function_name, (_function_name##_Type)&__class::_function ); } \
	}; \
	...
	static Gamma::SGlobalExe _function_name##_get_table( _function_name##_Impl_Class::__class::InsallGetVirtualTable() );\
